...
class BoardTestSuite {
    ...
    public void testAddTaskListAverageWorkingOnTask() {
        ...
        inProgressList.addTask(new Task("Task 1", "Description", null, null, LocalDate.now().minusDays(10), LocalDate.now().plusDays(5)));
        inProgressList.addTask(new Task("Task 2", "Description", null, null, LocalDate.now().minusDays(5), LocalDate.now().plusDays(10)));

        project.addTaskList(inProgressList);

        double average = project.calculateAverageDurationInProgress();

        assertEquals(7.5, average, 0.1);
    }
