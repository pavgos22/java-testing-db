package com.junit.testing.library;

import com.junit.testing.library.Book;
import com.junit.testing.library.BookLibrary;
import com.junit.testing.library.LibraryDatabase;
import com.junit.testing.library.LibraryUser;
...
class BookDirectoryTestSuite {
    ...
    void testListBooksInHandsOfNone() {
        ...
        LibraryUser user = new LibraryUser("Adam", "Nowak", "1234567890");
        List<Book> noBooks = new ArrayList<>();
        when(libraryDatabaseMock.listBooksInHandsOf(user)).thenReturn(noBooks);

        // When
        List<Book> theBooks = bookLibrary.listBooksInHandsOf(user);

        // Then
        assertEquals(0, theBooks.size());
    }
